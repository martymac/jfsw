...
2. Open a terminal, change into the source code directory, and compile the game with: `make` or `gmake` (BSD)
3. Assuming that was successful, run the game with: `./sw`
